    ...
    minus[crrNum].onclick = minusWork;
        ...
        function minusWork(ev) { // 주문 수량을 감소시키는 함수
            if (this.parentNode.parentNode.children[1].firstChild.textContent !== '1'){
                ...
                this.parentNode.parentNode.parentNode.children[2].textContent = costSum - (Number(imgEls[crrNum].parentNode.children[2].textContent))
            } else return;
        ...
        function cancelWork (ev) { // 선택한 메뉴를 취소하는 함수
            ...
            if (ev.target === cancelLis[crrNum]) {
                ...
                if (cancel == true) {
                    ...
                    this.parentNode.parentNode.parentNode.children[2].textContent -= this.children[2].textContent;
                } else return;
            } else {return}
        }
